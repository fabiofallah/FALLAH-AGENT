...
ok(html.includes('VERSÃO 1.0.0 | PATCH 124'),'footer patch 124');
ok(html.includes('PROVA DO MOTOR — PATCH 124'),'proof patch 124');
...
ok(engine.includes("const PATCH_TAG = 'PATCH_124'"),'engine patch tag');
...
ok(engine.includes("'PATCH_124_ARBITRAGE_PIPELINE.log'"),'no legacy runtime log');
console.log('PATCH 124 consolidated regression: OK');
